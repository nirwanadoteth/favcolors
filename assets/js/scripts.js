function openWarna(namawarna) {
	...
	var desktopButtons = document.querySelectorAll('.desktop-nav button');
	...
	var clickedButton = document.querySelector(
		`.desktop-nav button[onclick="openWarna('${namawarna}')"]`
	);
	if (clickedButton) {
	...
	var mobileButton = document.querySelector(
		`.dropdown-item[onclick="selectMobileOption('${namawarna}')"]`
	);
	if (mobileButton) {
...
document.addEventListener('DOMContentLoaded', function () {
	var homeButton = document.querySelector(
		`.desktop-nav button[onclick="openWarna('Home')"]`
	);
	if (homeButton) {
		homeButton.classList.add('active');
	}

	var mobileHomeButton = document.querySelector(
		`.dropdown-item[onclick="selectMobileOption('Home')"]`
	);
	if (mobileHomeButton) {
